...
[the pile](../../vq_hlm/train_hlm_single_model/run_train_thepile.py)的训练也支持，但目前只能支持python run_train_thepile.py启动，要进去改参数，还没有写对应脚本，原框架支持streaming有问题，自己写的显存分配有问题，gpu mem拉不满，建议暂时不要使用，还是用GPT+wiki103练手（多卡跑倒是可以跑）
